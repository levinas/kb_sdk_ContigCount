...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ContigCount'):
...
impl_ContigCount = ContigCount(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['ContigCount.count_contigs_async'] = ['ContigCount', 'count_contigs']
async_check_methods['ContigCount.count_contigs_check'] = ['ContigCount', 'count_contigs']
sync_methods['ContigCount.count_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'ContigCount'
        ...
        self.rpc_service.add(impl_ContigCount.count_contigs,
                             name='ContigCount.count_contigs',
                             types=[basestring, basestring])
        self.method_authentication['ContigCount.count_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "ContigCount but no authentication header was passed"
                            raise err
